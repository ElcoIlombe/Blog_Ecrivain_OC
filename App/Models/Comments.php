...
class Comments extends \Core\Model
{
	public static function thisComment()
    {
        try {
            $db = static::getDB();
                ...
                $stmt = $db->prepare('SELECT id, post_id, author, comment, comment_date, report FROM comments WHERE post_id = ?  ORDER BY comment_date DESC');
    ...
    public static function report()
    {
        ...
        try {
            ...
            $stmnt = $db->prepare('
                UPDATE comments SET report = "1" WHERE id = ?');
